(function (window, undefined) {
    ...
    seven.fn = seven.prototype = {
        ...
        animate: function (args) {
            ...
            for (var i = 0; i < this.elements.length; i++) {
                var obj = this.elements[i];
                var targetX = settings.left;
                var targetY = settings.top;
        ...
        rotation1: function (interval) {
            ...
            function toShow(index) {
                for (var y = 0; y < aLiOl.length; y++) {
                    aLiOl[y].className = '';
                    self.opacity(aLiUl[y], {opacity: 0});
                }
                aLiOl[index].className = 'active';
                obj.style.display = 'block';
                self.opacity(aLiUl[index], {opacity: 100});
            }
